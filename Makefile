...
all:
	...
	$(CC) $(CFLAGS) main.o init.o midi.o midi_in.o midi_out.o mididump.o misc.o interface_hw.o interface_hw_lib.o interface_curses.o user_input.o PCD8544.o -o $(PROGNAME) $(LIBS)
